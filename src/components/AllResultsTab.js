...
const AllResultsTab = ({
  ...
  const renderStatusButton = (isPassed, result, checklistType) => {
    ...
    return (
      <View style={[styles.statusButton, { backgroundColor: isPassed ? "#28a745" : "#dc3545" }]}>
  ...
  const renderScore = (score, category, testType, result) => {
    ...
    return (
      <TouchableOpacity
        onPress={() => onViewQuizDetails(result, testType)}
        activeOpacity={0.7}
        ...
        <View style={styles.tableContainer}>
          ...
          {results.map((result, index) => {
            ...
            return (
              ...
              >
                <TouchableOpacity 
                  style={[styles.cell, styles.cellNo]}
                ...
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={styles.cellText}>{result.date}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={styles.cellText}>{result.participantName}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[styles.cell, styles.cellIc]}
                  onPress={() => onViewDetails(result)}
                  activeOpacity={0.7}
                >
                  <Text style={styles.cellText}>{result.participantIc}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[styles.cell, styles.cellJawatan]}
                  onPress={() => onViewDetails(result)}
                  activeOpacity={0.7}
                >
