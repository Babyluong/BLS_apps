// combineBLSResultsFixed.js
// Fixed script to combine quiz_session and checklist_result data into bls_results
// This version prevents duplicates by clearing existing data first
...
async function combineBLSResultsFixed() {
  try {
    console.log('🚀 Starting BLS Results Combination Process (Fixed Version)...\n');

    // Step 1: Clear existing data to prevent duplicates
    console.log('1. Clearing existing bls_results data...');
    ...
    console.log('\n5. Creating combined bls_results records...');
    ...
    // Step 6: Insert bls_result records
    console.log('\n6. Inserting bls_results records...');
    await insertBLSResults(combinedResults);
...
async function insertBLSResults(combinedResults) {
...
module.exports = { combineBLSResultsFixed };
