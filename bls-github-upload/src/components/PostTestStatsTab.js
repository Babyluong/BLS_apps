      ...
      <View style={styles.modernChartCard}>
        <View style={styles.chartHeader}>
          ...
          <View style={styles.chartBadge}>
            <Text style={styles.chartBadgeText}>POST</Text>
          </View>
        </View>
    ...
    return (
      <View style={styles.emptyStatsContainer}>
        ...
        <Text style={styles.emptyStatsText}>
          No post-test data available yet.
        </Text>
      </View>
    );
  }
        ...
        <View style={styles.futuristicStatsContent}>
                ...
                <View style={styles.scoreValues}>
                  <View style={styles.scoreItem}>
                    ...
                    <Text style={styles.scoreValue}>
                      {highestScores?.clinical?.postTest || 0}
                    </Text>
                  </View>
                </View>
              ...
              >
                ...
                <View style={styles.scoreValues}>
                  <View style={styles.scoreItem}>
                    <Text style={styles.scoreLabel}>Highest Score</Text>
                    <Text style={styles.scoreValue}>
                      {highestScores?.nonClinical?.postTest || 0}
                    </Text>
                  </View>
                </View>
                <Text style={styles.clickHint}>Tap to see top 3</Text>
          ...
          {passFailStats && (
            <View style={styles.passFailSection}>
              <View style={styles.sectionHeader}>
                <Text style={styles.futuristicSectionTitle}>Post-Test Results</Text>
                <View style={styles.sectionGlow} />
              </View>
...
export default PostTestStatsTab;
